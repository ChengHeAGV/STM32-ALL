...
#define UART5_RX_LEN    130
#define RX_LEN 			20
#define TX_LEN          20
#define ADC1_DR_Addr   ((uint32_t)0x4001204C)
extern u16 AD_Value[30][3];
extern u8 rece_index,sendBuf[UART_RX_LEN],receBuf[UART_RX_LEN],*ps,*pr,rece5_index;
...
extern char rece5_buf[UART5_RX_LEN],send5_buf[UART5_RX_LEN];
