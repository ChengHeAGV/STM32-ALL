...
void USART3_IRQHandler(void)
{
    ...
    if(USART_GetITStatus(USART3, USART_IT_IDLE) != RESET)
    {
        ...
        YaoKong.ZhiXing_OR_XieXing = (rece3_buf[2]&0x02)>>1;
        YaoKong.XiaJiang = (rece3_buf[2]&0x04)>>2;
        YaoKong.JiTing = (rece3_buf[2]&0x08)>>3;
        YaoKong.KuaiSu_OR_ManSu = (rece3_buf[2]&0x10)>>4;
        YaoKong.QiSheng = (rece3_buf[2]&0x20)>>5;
        YaoKong.YaoGan_Key = (rece3_buf[2]&0x40)>>6;
